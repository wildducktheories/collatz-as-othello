...
\begin{remark}
  ...
  operation $x \mapsto gx + q$ is applied).  In forced cycles (where $\gamma > 1$), even
  $p$-value elements (halving steps) may possess $\Delta k$ values that fall outside the
  interval $[0, \Delta k_{\max}]$; the bound is not intended to constrain them.
\end{remark}
